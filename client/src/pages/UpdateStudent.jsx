...
const UpdateStudent = () => {
    ...
    const Save = async () => {
        ...
        await axios.post("http://localhost:5000/api/v1/UpdateStudent/"+Urlid,{
...
return (
    ...
    <div className="container mt-5">
        <div className="row shadow p-5 rounded">
            ...
            <div className="col-md-4 p-2">
                <label className="form-label">Update Student List</label><br/>
                <button onClick={Save} className="btn w-100 btn-success">Update</button>
            </div>
